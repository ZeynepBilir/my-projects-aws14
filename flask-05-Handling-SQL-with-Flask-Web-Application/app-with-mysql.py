...
app.config['MYSQL_DATABASE_HOST'] = 'zeynepsecond-sql.cgm7y1bc819o.us-east-1.rds.amazonaws.com'
app.config['MYSQL_DATABASE_USER'] = 'admin'
app.config['MYSQL_DATABASE_PASSWORD'] = 'Pl123456789'
app.config['MYSQL_DATABASE_DB'] = 'zeynepdb' #initial database kismi rds de
